...
test('buyer-start routes enforce clean redirect, paid sale gates, idempotency, and no sensitive logging', () => {
  ...
  assert.match(page, /searchParams\.status === 'pending'/)
  assert.match(page, /We are confirming your payment/)
  assert.match(page, /href="\/credit-map\/start"/)
  assert.match(page, /Return to the Credit Map/)
  assert.doesNotMatch(page, /Return to your Stripe confirmation/)
