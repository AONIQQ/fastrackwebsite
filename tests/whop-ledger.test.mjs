...
import { boundedMetadata, cents, disputeState, normalizeWhopEvent, sanitizeUtm, verifyWhopSignature } from '../lib/whop-ledger.mjs'
...
test('Whop normalizer retains only bounded ledger fields', () => {
  ...
  assert.deepEqual(event, { eventId: 'msg_fixture123', eventType: 'payment.succeeded', objectId: 'pay_fixture123', paymentId: 'pay_fixture123',
