    ...
    with risk_bound as (
      ...
      select classification,
        case
          ...
          when raw_source in ('direct', 'referral', 'google', 'bing', 'reddit', 'facebook', 'instagram', 'tiktok', 'forum', 'email', 'youtube', 'podcast')
            then raw_source
          else 'other'
        end as source
      from risk_bound
    ...
    with classified as (
      select case
        when lower(coalesce(utm_source, utm->>'utm_source',
          ...
          in ('direct', 'referral', 'google', 'bing', 'reddit', 'facebook', 'instagram', 'tiktok', 'forum', 'email', 'youtube', 'podcast')
