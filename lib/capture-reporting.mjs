...
export const PUBLIC_CAPTURE_SOURCES = new Set([
  'direct', 'referral', 'google', 'bing', 'reddit', 'facebook', 'instagram',
  'tiktok', 'forum', 'email', 'youtube', 'podcast',
])

export function publicCaptureSource(value, { fixture = false } = {}) {
  if (fixture) return 'fixture'
  const normalized = typeof value === 'string' ? value.toLowerCase() : ''
  return PUBLIC_CAPTURE_SOURCES.has(normalized) ? normalized : 'other'
}
