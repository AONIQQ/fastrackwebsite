...
export async function completeCapture({
  fetcher, payload, onAcknowledged, timeoutMs = 10_000,
  endpoint = '/api/insertEmailDocument', headers = {},
}) {
  const acknowledgement = await postCapture(fetcher, payload, { timeoutMs, endpoint, headers })
