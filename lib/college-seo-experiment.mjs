const EXPERIMENTS = Object.freeze({
  ...
  233921: Object.freeze({
    canonicalPath: '/college/233921-virginia-polytechnic-institute-and-state-university',
    searchName: 'Virginia Tech',
    residencyNote: 'Residency classification determines which published tuition applies; choosing in-state in the calculator does not establish eligibility.',
  }),
  232186: Object.freeze({
    canonicalPath: '/college/232186-george-mason-university',
    searchName: 'George Mason University',
    residencyNote: 'Residency classification determines which published tuition applies; choosing in-state in the calculator does not establish eligibility.',
  }),
  224554: Object.freeze({
    canonicalPath: '/college/224554-east-texas-a-m-university',
    searchName: 'East Texas A&M University',
    residencyNote: 'Residency classification determines which published tuition applies; choosing in-state in the calculator does not establish eligibility.',
  }),
})
