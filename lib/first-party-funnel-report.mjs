export const FIRST_PARTY_FUNNEL_REPORT_SQL = `
  ...
  select report_window as "window", traffic_class, source, medium, campaign, intent, modal_opened,
  ...
  from counts
  order by case report_window when '7d' then 1 else 2 end, traffic_class, intent desc, source, campaign
`
